...
export interface LinkAjaOneTimePaymentSampleResponse {
  id: string;
  businessId: string;
  referenceId: string;
  status: string;
...
export const linkAjaOneTimePaymentSampleResponseSchema: Schema<LinkAjaOneTimePaymentSampleResponse> = object(
  {
    id: ['id', string()],
