...
export interface GcashOneTimePaymentSampleResponse {
  id: string;
  businessId: string;
  referenceId: string;
  status: string;
...
export const gcashOneTimePaymentSampleResponseSchema: Schema<GcashOneTimePaymentSampleResponse> = object(
  {
    id: ['id', string()],
