...
export interface PaymayaTokenizedPaymentsSampleResponse {
  id: string;
  businessId: string;
  referenceId: string;
  status: string;
...
export const paymayaTokenizedPaymentsSampleResponseSchema: Schema<PaymayaTokenizedPaymentsSampleResponse> = object(
  {
    id: ['id', string()],
