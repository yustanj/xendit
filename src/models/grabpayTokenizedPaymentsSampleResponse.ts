...
export interface GrabpayTokenizedPaymentsSampleResponse {
  id: string;
  businessId: string;
  referenceId: string;
  status: string;
...
export const grabpayTokenizedPaymentsSampleResponseSchema: Schema<GrabpayTokenizedPaymentsSampleResponse> = object(
  {
    id: ['id', string()],
    ...
    channelProperties: ['channel_properties', nullable(string())],
