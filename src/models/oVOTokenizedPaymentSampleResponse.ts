...
export interface OVOTokenizedPaymentSampleResponse {
  id: string;
  businessId: string;
  referenceId: string;
  status: string;
...
export const oVOTokenizedPaymentSampleResponseSchema: Schema<OVOTokenizedPaymentSampleResponse> = object(
  {
    id: ['id', string()],
