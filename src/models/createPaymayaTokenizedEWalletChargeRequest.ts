...
export interface CreatePaymayaTokenizedEWalletChargeRequest {
  referenceId: string;
  currency: string;
  amount: number;
...
export const createPaymayaTokenizedEWalletChargeRequestSchema: Schema<CreatePaymayaTokenizedEWalletChargeRequest> = object(
  {
